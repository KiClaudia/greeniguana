...
pdf('PrePostDietTrtGroupBKA.pdf',
    width = 10, height = 7)
PrePostGlucoseBKA <- boxplot(glucose$X0324bka, glucose$X0423bka, water$X0423bka, water$X0324bka, xlab = "Treatment Groups", 
...
pdf('PrePostDietTrtGroupLys.pdf',
    width = 10, height = 7)
PrePostGlucoseLys <- boxplot(glucose$X0324lys, glucose$X0423lys, water$X0423lys, water$X0324lys, xlab = "Treatment Groups", 
                             ylab = "Lysis Score", 
...
pdf('PrePostDietTrtGroupAgg.pdf',
    width = 10, height = 7)
PrePostGlucoseAgg <- boxplot(glucose$X0324agg, glucose$X0423agg, water$X0423agg, water$X0324agg, xlab = "Treatment Groups", 
...
pdf('PrePostDietTrtGroupGlu.pdf',
    width = 10, height = 7)
PrePostGlucoseGlu <- boxplot(glucose$X0324glu, glucose$X0423glu, water$X0423glu, water$X0324glu, xlab = "Treatment Groups", 
...
pdf('PrePostDietTrtGroupMass.pdf',
    width = 10, height = 7)
PrePostGlucoseMass <- boxplot(glucose$X0324mass, glucose$X0423mass, water$X0423mass, water$X0324mass, xlab = "Treatment Groups", 
                             ylab = "Mass g", 
...
pdf('PrePostDietTrtGroupGly.pdf',
    width = 10, height = 7)
PrePostGlucoseGly <- boxplot(glucose$X0324gly, glucose$X0423gly, water$X0423gly, water$X0324gly, xlab = "Treatment Groups", 
...
pdf('PrePostDietTrtGroupTotri.pdf',
    width = 10, height = 7)
PrePostGlucoseTotri <- boxplot(glucose$X0324totri, glucose$X0423totri, water$X0423totri, water$X0324totri, xlab = "Treatment Groups", 
...
pdf('PrePostDietTrtGroupTrtri.pdf',
    width = 10, height = 7)
PrePostGlucoseTrtri <- boxplot(glucose$X0324trtri, glucose$X0423trtri, water$X0423trtri, water$X0324trtri, xlab = "Treatment Groups", 
...
pdf('PrePostDietTrtGroupOSI.pdf',
    width = 10, height = 7)
PrePostGlucoseOSI <- boxplot(glucose$X0324oi, glucose$X0423oi, water$X0423oi, water$X0324oi, xlab = "Treatment Groups", 
...
pdf('PrePostDietTrtGroupDROM.pdf',
    width = 10, height = 7)
PrePostGlucoseDROM <- boxplot(glucose$X0324drom, glucose$X0423drom, water$X0423drom, water$X0324drom, xlab = "Treatment Groups", 
...
pdf('PrePostDietTrtGroupOXY.pdf',
    width = 10, height = 7)
PrePostGlucoseOXY <- boxplot(glucose$X0324oxy, glucose$X0423oxy, water$X0423oxy, water$X0324oxy, xlab = "Treatment Groups", 
