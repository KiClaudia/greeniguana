...
```
Note* Data for first challenge was logged and inflated by 0.0001 for normality (outlier was also taken out, more than 10x avg), data for second challenge was logged.
...
1) Main effect of diet (glucose higher)
2) Main effect of time (0528 and 0628)
